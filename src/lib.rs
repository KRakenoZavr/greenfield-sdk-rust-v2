...
pub mod greenfield {
    pub mod bridge {
        include!("prost/greenfield/greenfield.bridge.rs");
    }

    pub mod challenge {
        include!("prost/greenfield/greenfield.challenge.rs");
    }

    pub mod common {
        include!("prost/greenfield/greenfield.common.rs");
    }

    pub mod gensp {
        include!("prost/greenfield/greenfield.gensp.rs");
    }

    pub mod payment {
        include!("prost/greenfield/greenfield.payment.rs");
    }

    pub mod permission {
        include!("prost/greenfield/greenfield.permission.rs");
    }

    pub mod resource {
        include!("prost/greenfield/greenfield.resource.rs");
    }

    pub mod sp {
        include!("prost/greenfield/greenfield.sp.rs");
    }

    pub mod storage {
        include!("prost/greenfield/greenfield.storage.rs");
    }
}
